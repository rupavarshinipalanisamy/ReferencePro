                ...
                <View>
                    <View style={styles.tabContainer}>
                        <TouchableOpacity style={[p5, { borderBottomWidth: activeTab === 'allChat' ? 3 : 0, borderBottomColor: activeTab === 'allChat' ? colors.white : ""}]} onPress={() => handleTabPress('allChat')}>
                            <Text style={[styles.tabText, {color : activeTab === 'allChat' ? colors.white : colors.purpleVar2
}]}>All Chats</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[p5, { borderBottomWidth: activeTab === 'pinnedChat' ? 3 : 0, borderBottomColor: activeTab === 'pinnedChat' ? colors.white : ""}]} onPress={() => handleTabPress('pinnedChat')}>
                            <View style={[flexRow, spaceBetween]}>
                                <Text style={[styles.tabText, {color : activeTab === 'pinnedChat' ? colors.white : colors.purpleVar2
}]}>Pinned Chat</Text>
                                <View style={[styles.roundNumber,{ backgroundColor: activeTab === 'pinnedChat' ? colors.white : colors.purpleVar2
 }]}>
                        ...
                        <TouchableOpacity style={[p5, { borderBottomWidth: activeTab === 'archiveChat' ? 3 : 0, borderBottomColor: activeTab === 'archiveChat' ? colors.white : "" }]} onPress={() => handleTabPress('archiveChat')}>
                            <View style={[flexRow, spaceBetween]}>
                                <Text style={[styles.tabText, {color : activeTab === 'archiveChat' ? colors.white : colors.purpleVar2
}]}>Archive Chat</Text>
                                <View style={[styles.roundNumber,{ backgroundColor: activeTab === 'archiveChat' ? colors.white : colors.purpleVar2
 }]}>
