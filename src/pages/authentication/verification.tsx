...
import { ph30, flexRow, spaceBetween, mt20, pt25, flex1, mh25, mv30, m28, } from '../../components/commonStyles';
        ...
        return otp.map((value, index) => (
            <View key={index}>
                <OtpInput
                    ...
                    style={{
                        borderWidth: 1,
                        borderColor: value ? colors.purpleVar3 : isDark() ? colors.darkModeVar5 : colors.borderBottomColor,
                        backgroundColor: value ? isDark() ? colors.darkModeVar6 : colors.purpleVar1 : isDark() ? colors.darkModeVar7 : colors.white
                    }}
