...
import { flexRow, mt20, alignItemsCenter, ph15, mh20, spaceBetween, mh30, mt8, mv20, mt30, flex1, justyfyCenter, mh10 } from '../../components/commonStyles';
import { H16fontNormalGray4, H12fontNormalGray, H14font400Gray4, H16font600Black, H18BlackText } from '../../components/commonText';
import { RowSpaceBetween, TopContainerWhiteCard } from '../../components/commonView';
            ...
            <View style={[flex1, { backgroundColor: isDarkTheme ? colors.darkModeVar2 : colors.whiteVar0 }]} >
                <TopContainerWhiteCard style={{ backgroundColor: isDarkTheme ? colors.darkModeVar1 : colors.white }}>
                    <View style={[flexRow]}>
                        ...
                        <H18BlackText style={{ color: isDarkTheme ? colors.white : colors.black }} >{labels.chat}</H18BlackText>
                    </View>
                </TopContainerWhiteCard>
                <View style={[mh20, mt20]}>
                    <H16fontNormalGray4 style={{ color: isDarkTheme ? colors.greyVar0 : colors.greyVar4 }}>{labels.theme} </H16fontNormalGray4>
                            ...
                            <View key={data.id} style={[flexRow, spaceBetween]}>
                                <View style={{ paddingVertical: 10 }}>
                                    <TouchableOpacity
                                        ...
                                        <H16fontNormalGray4 style={{ color: isDarkTheme ? colors.greyVar0 : colors.greyVar4 }}>
                                            {data.chatSettings}
                                        </H16fontNormalGray4>
                                    </TouchableOpacity>
                                </View>
                                {index === 2 ? (
                                    ...
                                    <CustomIcon name='chevron-right' size={15} color={isDarkTheme ? colors.purpleVar2 : colors.black} type='octicons' />
                                )}
                            </View>
                        );
                    })}
