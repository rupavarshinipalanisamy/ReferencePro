...
import { flexRow, mh20, pt10 } from '../../components/commonStyles';
            ...
            <ScrollView style={{ flex: 1 }}>
              ...
              {chatMessages1.map((item, index) => (
                ...
                >
                  ...
                  >
                    <TouchableOpacity style={[item.type === 'sentmsg' ? { alignItems: 'flex-end' } : { alignItems: 'flex-start' }, { backgroundColor: selectedCards.includes(item.id) ? (isDark() ? colors.darkModeVar6 : colors.purpleVar4) : 'transparent', paddingHorizontal: 20 }]}
                      onPress={() => {
                        if (selectedCards.length === 0) {
                          console.log('--');
                        } else {
